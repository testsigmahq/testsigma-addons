...
public class ScrollInsideElementWithDuration extends IOSAction {
    ...
    /**
     * Maps a direction string to [startX, startY, endX, endY] coordinates relative to the element bounds.
     * Horizontal swipes keep Y fixed at the vertical centre of the element.
     * Vertical swipes keep X fixed at the horizontal centre of the element.
     */
