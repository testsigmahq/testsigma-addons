...
@Data
@Action(actionText = "Press Control key and alpha-numeric combination, Control key: Control-Key , Combination key: Combination-key",
        ...
        displayName = "Press Control key and alpha-numeric combination",
        useCustomScreenshot = true)
public class PressControlOrFunctionKeyWithCombination extends WindowsAdvancedAction {
