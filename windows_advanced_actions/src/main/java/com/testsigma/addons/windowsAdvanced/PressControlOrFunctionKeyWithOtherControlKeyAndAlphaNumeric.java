...
@Action(actionText = "Press Control key with other control key and alpha numeric combination, Control key 1: Control-Key , Control key 2: Combination-key1, Alpha-numeric key: Combination-key2",
        ...
        displayName = "Press Control key with other control key and alpha numeric combination",
        useCustomScreenshot = true)
public class PressControlOrFunctionKeyWithOtherControlKeyAndAlphaNumeric extends WindowsAdvancedAction {
