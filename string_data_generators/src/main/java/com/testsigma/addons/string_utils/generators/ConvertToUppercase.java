...
@Data
@com.testsigma.sdk.annotation.TestDataFunction(displayName = "toUppercase(string)",
        description = "Converts the given string to upper case")
public class ConvertToUppercase extends TestDataFunction {
    ...
    public TestData generate() throws Exception {
        return new TestData(string.getValue().toString().toUpperCase());
    }
}