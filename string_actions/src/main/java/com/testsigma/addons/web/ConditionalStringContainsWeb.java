...
@Action(actionText = "Verify if string1 contains string2",
        ...
        applicationType = ApplicationType.WEB , actionType = StepActionType.IF_CONDITION)
public class ConditionalStringContainsWeb extends StringContainsValidationWeb {
