...
@Action(actionText = "Verify if string1 contains string2",
        ...
        applicationType = ApplicationType.IOS , actionType = StepActionType.IF_CONDITION)
public class ConditionalStringContainsValidationIos extends StringContainsValidationWeb {
