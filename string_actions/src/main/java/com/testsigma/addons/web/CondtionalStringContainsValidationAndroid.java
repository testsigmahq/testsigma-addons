...
@Action(actionText = "Verify if string1 contains string2",
        ...
        applicationType = ApplicationType.ANDROID , actionType = StepActionType.IF_CONDITION)
public class CondtionalStringContainsValidationAndroid extends StringContainsValidationWeb {
