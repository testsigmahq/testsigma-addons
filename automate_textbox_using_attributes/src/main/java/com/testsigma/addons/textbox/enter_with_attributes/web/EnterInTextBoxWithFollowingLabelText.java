...
@Data
@Action(actionText = "Enter test-data in the text box with following label text value",
        description = "Enters data into the text box for given following label",
        applicationType = ApplicationType.WEB)
public class EnterInTextBoxWithFollowingLabelText extends EnterInTextBoxBasedOnAttributes {
