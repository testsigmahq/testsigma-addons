...
@Data
@Action(actionText = "Enter test-data in the text box with following text value",
        description = "Enters data into the text box for given following text",
        applicationType = ApplicationType.WEB)
public class EnterInTextBoxWithFollowingText extends EnterInTextBoxBasedOnAttributes {
