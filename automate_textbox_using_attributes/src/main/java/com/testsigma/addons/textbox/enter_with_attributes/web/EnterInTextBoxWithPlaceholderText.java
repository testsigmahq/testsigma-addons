...
@Data
@Action(actionText = "Enter test-data in the text box with placeholder value",
        description = "Enters data into the text box for given placeholder",
        applicationType = ApplicationType.WEB)
public class EnterInTextBoxWithPlaceholderText extends EnterInTextBoxBasedOnAttributes {
