...
@Data
@Action(actionText = "Enter test-data in the text box with preceding text value",
        description = "Enters data into the text box for given preceding text",
        applicationType = ApplicationType.WEB)
public class EnterInTextBoxWithPrecedingText extends EnterInTextBoxBasedOnAttributes {
