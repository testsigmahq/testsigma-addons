...
@Data
@Action(actionText = "Enter test-data in the text box with preceding label text value",
        description = "Enters data into the text box for given preceding label",
        applicationType = ApplicationType.WEB)
public class EnterInTextBoxWithPrecedingLabelText extends EnterInTextBoxBasedOnAttributes {
