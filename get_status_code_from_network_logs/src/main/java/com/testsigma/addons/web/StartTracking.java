...
import static com.testsigma.addons.web.utilities.ResponseDataUtilities.addStatusCodeData;

@Data
@Action(actionText = "Add Network Listener to track the status code for the request url url_value and the request " +
        "method method_value",
        description = "Add Network Listener to track the status code for the given request url " +
                "and given request method",
...
public class StartTracking extends WebAction {
    ...
    public Result execute() {
        ...
        try {
            ...
            setErrorMessage("Exception occurred while adding Network Status Code Listener to the driver: "
                    + e.getMessage());
            return Result.FAILED;
        }

        // Log success message
        logger.info("Successfully added Network Status Code Listener to the driver.");
        setSuccessMessage("Added Network Status Code Listener to the driver.");
