...
import static com.testsigma.addons.web.utilities.ResponseDataUtilities.getStatusCode;


@Action(actionText = "get the status code of the stored URL and store it in runtime variable status_code",
        description = "This action retrieves the status code of the stored URL from StartTrackingV3.",
...
public class GetStatusCode extends WebAction {
    ...
    public Result execute() {
        try {
            ...
            logger.warn("Error retrieving status code: " + e.getMessage());
