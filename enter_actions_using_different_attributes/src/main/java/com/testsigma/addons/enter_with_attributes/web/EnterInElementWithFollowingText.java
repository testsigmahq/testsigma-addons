...
@Data
@Action(actionText = "Enter test-data in the element with following text value",
        description = "Enters the test-data in the element that matches provided following text",
        applicationType = ApplicationType.WEB)
public class EnterInElementWithFollowingText extends EnterInElementBasedOnAttributes {
