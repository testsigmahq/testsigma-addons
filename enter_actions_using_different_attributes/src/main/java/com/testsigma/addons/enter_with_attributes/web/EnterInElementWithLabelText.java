...
@Data
@Action(actionText = "Enter test-data in the element with label text value",
        description = "Enters the test-data in the element that matches provided label text",
        applicationType = ApplicationType.WEB)
public class EnterInElementWithLabelText extends EnterInElementBasedOnAttributes {
