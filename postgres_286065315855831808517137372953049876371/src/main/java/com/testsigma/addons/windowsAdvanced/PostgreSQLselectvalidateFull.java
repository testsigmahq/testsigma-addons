...
@Action(actionText = "Execute PostgreSQL Select_Query on the connection DB_Connection_URL and verify full output" +
...
public class PostgreSQLselectvalidateFull extends WindowsAdvancedAction {
