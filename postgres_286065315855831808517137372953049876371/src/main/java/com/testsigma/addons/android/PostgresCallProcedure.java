...
@Data
@Action(actionText = "Call PostgreSQL Stored Procedure Query on the Connection PG_DB_Connection_URL", description = "Executes a PostgreSQL CALL query", applicationType = ApplicationType.ANDROID)
