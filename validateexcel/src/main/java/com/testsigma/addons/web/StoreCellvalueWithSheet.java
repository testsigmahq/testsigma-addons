...
@Data
@Action(actionText = "Read the Excel filepath with Cell value rowNo,columnNo and Sheet sheetIndex store into a variable testdata",
		description = "Read the cell value from the Excel file ",
		applicationType = ApplicationType.WEB)
public class StoreCellvalueWithSheet extends WebAction {
