...
@Data
@Action(actionText = "Write the data data_value into xlsx file in newline where absolutepath is test_data and store rownumber into a variable testdata",
...
public class WriteNewExcelFile extends WebAction {
	...
	public com.testsigma.sdk.Result execute() throws NoSuchElementException {
		...
		String xlsxfile = filePath.getValue().toString();
