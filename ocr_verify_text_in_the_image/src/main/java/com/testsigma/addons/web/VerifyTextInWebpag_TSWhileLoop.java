...
@Data
@Action(actionText = "Verify the text testdata present in the webpage",
description = "Using OCR verifying that the text present in the webpage",
applicationType = ApplicationType.WEB,
		actionType = StepActionType.WHILE_LOOP,
        useCustomScreenshot = false)
public class VerifyTextInWebpag_TSWhileLoop extends WebAction {
