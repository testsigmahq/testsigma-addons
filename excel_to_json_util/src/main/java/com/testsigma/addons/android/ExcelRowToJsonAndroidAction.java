...
@Action(actionText = "store the entire row row-number from excel/csvfile file-path into the format in runtime variable variable-name",
        description = "Converts a specified row from Excel (XLS/XLSX) or CSV file to JSON format using headers as keys",
        applicationType = ApplicationType.ANDROID,
        useCustomScreenshot = false)
public class ExcelRowToJsonAndroidAction extends AndroidAction {
