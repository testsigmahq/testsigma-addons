...
@Action(actionText = "Extract No_Of_Words words before text text-to-verify from PDF file-path and store in a runtime variable runtime-variable",
        description = "Extracts the text from the PDF and stores the extracted text into a run time variable",
        applicationType = ApplicationType.WINDOWS_ADVANCED,
        displayName = "Extract words before text from PDF")
public class NoofwordsBeforetext extends WindowsAdvancedAction {
