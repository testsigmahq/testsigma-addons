...
public class RemoveSpecialChar extends AndroidAction
{
    ...
    public Result execute() throws NoSuchElementException 
    {
        ...
        { 
            ...
            System.out.println("Successfully removed special characters from " + data + " and stored the Data in runtime variable => " + runtimeVar.getValue().toString( ) + " = " + RES);
