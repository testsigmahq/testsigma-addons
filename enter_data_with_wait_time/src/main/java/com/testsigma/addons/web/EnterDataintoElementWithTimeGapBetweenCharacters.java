...
@Action(actionText = "Enter value into element-locator with a time gap of time-in-ms milliseconds between characters",
        description = "This action types the given data into a UI element, character by character, with a specified delay between each keystroke.",
        applicationType = ApplicationType.MOBILE_WEB)
public class EnterDataintoElementWithTimeGapBetweenCharacters extends WebAction {
