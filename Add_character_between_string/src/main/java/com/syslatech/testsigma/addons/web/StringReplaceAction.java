...
@Data
@Action(actionText = "Replace string1 with string2 in the given text String3 and store into testdata", description = "Replaces all occurrences of string1 with string2 in the text and stores the modified text into a runtime variable", applicationType = ApplicationType.WEB, useCustomScreenshot = false)
public class StringReplaceAction extends WebAction {
