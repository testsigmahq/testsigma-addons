...
@Data
@Action(actionText = "Add character test-data1 to the String test-data2 from end position ( End ) and store into testdata", description = "Adds the specified character to the string at the given position from the end and stores it in runtime data", applicationType = ApplicationType.WEB, useCustomScreenshot = false)
public class AddCharacterToStringByPassingEndPosition extends WebAction {
