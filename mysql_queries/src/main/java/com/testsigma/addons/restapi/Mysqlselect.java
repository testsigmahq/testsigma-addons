...
@Data
@Action(actionText = "Execute MySQL Select-Query on the connection DB_Connection_URL and store the first cell output into a runtime variable variable-name",
...
public class Mysqlselect extends RestApiAction {
