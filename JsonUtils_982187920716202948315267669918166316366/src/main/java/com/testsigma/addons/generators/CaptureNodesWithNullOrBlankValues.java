...
public class CaptureNodesWithNullOrBlankValues extends WebAction {
    ...
    protected Result execute() throws NoSuchElementException {
        try {
            ...
            try {
                ...
                // print the issues list for debugging
                logger.info("Identified Issues: " + issues.toString());
                ...
                if (issues.isEmpty()) {
                    ...
                    setErrorMessage("Found " + issues.size() + " node(s) with null or blank values." +
                            " Stored details in runtime variable: " +
                            variable_name.getValue().toString() + " = <b>" + output + "</b>");
