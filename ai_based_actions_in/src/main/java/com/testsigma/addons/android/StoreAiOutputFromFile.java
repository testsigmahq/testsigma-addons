...
@Data
@Action(actionText = "Ai: Store the AI output using prompt ai-prompt-text-input on file file-path into a runtime variable runtime-variable",
...
public class StoreAiOutputFromFile extends AndroidAction {
    ...
    public Result execute() {
        logger.info("=== StoreAiOutputFromFile (Android): Starting ===");
