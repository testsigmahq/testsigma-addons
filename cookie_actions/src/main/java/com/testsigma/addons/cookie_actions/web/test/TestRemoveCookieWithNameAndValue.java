...
import com.testsigma.addons.cookie_actions.mobile_web.RemoveCookieWithNameAndValue;
...
public class TestRemoveCookieWithNameAndValue {
    ...
    public void validate() throws Exception {
        RemoveCookieWithNameAndValue nlp = new RemoveCookieWithNameAndValue();
