...
@Data
@Action(actionText = "Add cookie to the session with cookie_name and cookie_value with expiry_time and path ",
    description = "Add cookies to currently running session when sent as a key and value pair with expiry_time and path.Expiry time should be in this sample format -Thu, 18 Dec 2023 11:00:00 UTC",
    applicationType = ApplicationType.WEB)

public class AddCookieWithExpiryAndPath extends WebAction {
  ...
  public Result execute() throws NoSuchElementException {
    ...
    try {
      ...
      js.executeScript("document.cookie = \"" + cookieName.getValue().toString() + "=" + cookieValue.getValue().toString() + "; expires=" + cookieExpiry.getValue().toString() + "; path=" + cookiePath.getValue().toString() + "\";\r\n"
          + "");
