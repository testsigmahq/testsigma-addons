...
public class AddCookieWithExpiryAndDomain extends WebAction {
  ...
  public Result execute() throws NoSuchElementException {
    ...
    try {
      ...
      js.executeScript("document.cookie = \"" + cookieName.getValue().toString() + "=" + cookieValue.getValue().toString() + "; domain=" + cookieDomain.getValue().toString() + "; expires=" + cookieExpiry.getValue().toString() + "; path=/\";\r\n"
          + "");
      logger.info("Success in adding cookies with expiry setting " +
          "status to pass cookie name ::" + this.cookieName.getValue() +
          " value::" + this.cookieValue.getValue().toString() +
          " cookieExpiry::" + this.cookieExpiry.getValue().toString() +
          " cookieDomain::" + this.cookieDomain.getValue().toString()
      );
    } catch (Exception e) {
      result = Result.FAILED;
      setErrorMessage("Could not add cookies with given key  " + cookieName.getValue().toString() + "  and value   " + cookieValue.getValue().toString() + "  .Check for other details.");
