...
import com.testsigma.addons.cookie_actions.mobile_web.VerifyCookieWithNameExists;
...
public class TestVerifyCookieWithNameExists {
    ...
    public void validate() throws Exception {
        VerifyCookieWithNameExists nlp = new VerifyCookieWithNameExists();
