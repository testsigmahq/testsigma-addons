...
public class SwipeUntilElementVisible extends AndroidAction {
    ...
    public Result execute() throws NoSuchElementException {
        try {
            ...
            for (int attempt = 1; attempt <= MAX_SWIPES; attempt++) {
                ...
                performSwipe(direction, androidDriver);
            }
    ...
    private void performSwipe(String direction, AndroidDriver androidDriver) {
