...
@Data
@Action(actionText = "SnowflakeDB: Execute Select Query query-string on the connection db-connection-url, private key private-key (Starts with BEGIN PRIVATE KEY) and verify output is expected-value",
...
public class ExecuteSelectQueryUsingPrivateKeyAndValidate extends WebAction {
