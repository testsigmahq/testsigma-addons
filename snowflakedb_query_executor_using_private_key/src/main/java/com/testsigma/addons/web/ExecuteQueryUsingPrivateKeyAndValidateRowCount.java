...
@Data
@Action(actionText = "SnowflakeDB: Execute Query query-string on the Connection db-connection-url, private key private-key (Starts with BEGIN PRIVATE KEY) and verify affected rows count is row-count",
        description = "This Action executes given SQL query and validates the affected rows count.",
        applicationType = ApplicationType.WEB)
public class ExecuteQueryUsingPrivateKeyAndValidateRowCount extends WebAction {
    ...
    public Result execute() throws NoSuchElementException {
        ...
        try{
            ...
            Statement stmt = SnowflakeDBConnection.getConnection(dbConnectionUrl1);
