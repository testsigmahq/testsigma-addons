...
@Data
@Action(actionText = "[Latest]Verify if test-data-1 operator test-data-2", description = "This is a numeric operation that finds relation between two numeric value", applicationType = ApplicationType.REST_API)
public class ConditionalOperators extends RestApiAction {
