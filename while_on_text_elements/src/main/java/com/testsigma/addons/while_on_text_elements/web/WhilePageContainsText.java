...
public class WhilePageContainsText extends WebAction {

    private static final String SUCCESS_MESSAGE = "Page Contains the Expected text";
    private static final String ERROR_MESSAGE = "Page does not contain the Expected text";
