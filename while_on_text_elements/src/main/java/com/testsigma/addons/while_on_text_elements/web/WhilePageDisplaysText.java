...
public class WhilePageDisplaysText extends WebAction {

    private static final String SUCCESS_MESSAGE = "Page displays the Expected text";
    private static final String ERROR_MESSAGE = "Page does not display the Expected text";
