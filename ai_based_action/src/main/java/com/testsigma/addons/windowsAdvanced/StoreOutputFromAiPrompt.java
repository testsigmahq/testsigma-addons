...
@Action(actionText = "Ai: store the output from prompt ai-prompt into a runtime variable runtime-variable",
        ...
        displayName = "Ai: Store output from AI prompt into runtime variable",
        applicationType = ApplicationType.WINDOWS_ADVANCED,
        useCustomScreenshot = true)
public class StoreOutputFromAiPrompt extends WindowsAdvancedAction {
    ...
    public Result execute() {
        logger.info("=== StoreOutputFromAiPrompt (WindowsAdvanced): Starting ===");
