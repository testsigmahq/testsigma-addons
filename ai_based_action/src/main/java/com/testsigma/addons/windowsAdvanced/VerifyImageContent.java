...
public class VerifyImageContent extends WindowsAdvancedAction {
    ...
    public Result execute() {
        logger.info("=== VerifyImageContent (WindowsAdvanced): Starting ===");
        ...
        try {
            ...
            // Determine logical screen size (OS-level DIP coordinates)
            ...
            // Annotation is drawn in capture pixel space (Stage A scale only)
