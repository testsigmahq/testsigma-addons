...
public class ClickOnImageUsingAi extends WindowsAction {
    ...
    public Result execute() {
        ...
        try {
            ...
            logger.info(String.format("Clicking at (%d,%d)  confidence=%d", logicalCX, logicalCY, confidence));
            new Actions(driver).moveToLocation(logicalCX, logicalCY).click().perform();
