...
@Action(actionText = "Ai: Hover on Image/text matching prompt prompt-describing-image",
        description = "Locate a UI element on a mobile web page using AI and move the touch pointer over it. " +
                "Fails if the element is not found.",
        displayName = "Ai: Hover on Image/text matching prompt",
        applicationType = ApplicationType.MOBILE_WEB,
        useCustomScreenshot = true)
public class HoverOnImageUsingAi extends WebAction {
    ...
    public Result execute() {
        logger.info("=== HoverOnImageUsingAi (Mobile Web): Starting ===");
        ...
        try {
            ...
            String aiResponse = AiActionUtils.invokeAi(ai, screenshotFile, AiActionUtils.LOCATE_PROMPT_MOBILE_WEB, query, logger);
