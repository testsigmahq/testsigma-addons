...
@Action(actionText = "Ai: Click on Image/text matching prompt prompt-describing-image",
        description = "Locate and tap a UI element on an Android device using two AI passes: " +
    ...
    public Result execute() {
        ...
        try {
            ...
            String aiResponse1 = AiActionUtils.invokeAi(
                    ai, screenshotFile, AiActionUtils.LOCATE_PROMPT_ANDROID, query, logger);
            ...
            annotatedJpegFile = AiActionUtils.captureAsJpeg(annotated1, "ai_android_annotated", logger);
            ...
            logger.info(String.format("Tapping at (%d,%d)  confidence=%d", tapX, tapY, conf1));
            ...
            setSuccessMessage(String.format(
                    ...
                    query, tapX, tapY, cap[0], cap[1], cap[2], cap[3], conf1, finalDesc));
