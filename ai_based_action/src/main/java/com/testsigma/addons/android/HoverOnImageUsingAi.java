...
@Action(actionText = "Ai: Hover on Image/text matching prompt prompt-describing-image",
        description = "Locate a UI element on an Android device using AI and move the touch pointer over it. " +
                "Fails if the element is not found.",
        displayName = "Ai: Hover on Image/text matching prompt",
        applicationType = ApplicationType.ANDROID,
        useCustomScreenshot = true)
public class HoverOnImageUsingAi extends AndroidAction {
    ...
    public Result execute() {
        logger.info("=== HoverOnImageUsingAi (Android): Starting ===");
