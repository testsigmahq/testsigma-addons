...
@Action(actionText = "Ai: Verify if the screen contains or matches the condition verification-query by scrolling through the page",
        description = "Captures 3 sequential screenshots while scrolling down the iOS screen and asks AI to verify " +
...
public class VerifyImageContentWithScroll extends IOSAction {
    ...
    public Result execute() {
        logger.info("=== VerifyImageContentWithScroll (iOS): Starting ===");
        ...
        try {
            ...
            screenshot1File = AiActionUtils.captureAsJpeg(capture1, "ai_ios_scroll_verify_1", logger);
            ...
            screenshot2File = AiActionUtils.captureAsJpeg(capture2, "ai_ios_scroll_verify_2", logger);
            ...
            screenshot3File = AiActionUtils.captureAsJpeg(capture3, "ai_ios_scroll_verify_3", logger);
    ...
    private void scrollDown(AppiumDriver appiumDriver) throws InterruptedException {
