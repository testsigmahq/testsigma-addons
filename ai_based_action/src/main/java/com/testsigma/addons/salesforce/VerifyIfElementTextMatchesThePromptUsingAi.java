...
public class VerifyIfElementTextMatchesThePromptUsingAi extends SalesforceAction {
    ...
    public Result execute() {
        logger.info("=== VerifyIfElementTextMatchesThePromptUsingAi (Salesforce): Starting ===");
