...
@Data
@Action(actionText = "Enter testdata on element with label text label-text where the element position is positions and the offset value offset-x, offset-y",
        description = "Enters text into an element near a label found using OCR, based on relative position",
        applicationType = ApplicationType.WINDOWS,
        useCustomScreenshot = true)

public class EnterTextNearLabelWithOffset extends WindowsAction {
