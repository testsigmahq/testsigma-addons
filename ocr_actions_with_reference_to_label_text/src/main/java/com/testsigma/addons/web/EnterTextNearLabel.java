...
@Data
@Action(actionText = "Enter testdata on element with label text label-text where the element position is positions",
        description = "Enters text into an element near a label found using OCR, based on relative position",
        applicationType = ApplicationType.WINDOWS,
        useCustomScreenshot = true)

public class EnterTextNearLabel extends WindowsAction {
