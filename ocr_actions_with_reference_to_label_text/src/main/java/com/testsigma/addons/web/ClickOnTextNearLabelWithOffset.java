...
@Data
@Action(actionText = "Click on element with label text label-text where the element position is positions and the offset value offset-x, offset-y",
        description = "Click on the text using the text coordinates relative to another text's position",
        applicationType = ApplicationType.WINDOWS,
        useCustomScreenshot = true)

public class ClickOnTextNearLabelWithOffset extends WindowsAction {
