...
@Data
@Action(actionText = "Click on element with label text label-text at occurrence position label-occurrence where the element position is positions",
...
public class ClickOnTextNearLabelOccurrenceBased extends WindowsAction {
