...
@Data
@Action(actionText = "Enter testdata on element with label text label-text at occurence label-occurence where the element position is positions",
        description = "Enters text into an element near a label found using OCR, based on relative position and label occurence",
        applicationType = ApplicationType.WINDOWS,
        useCustomScreenshot = true)

public class EnterTextNearLabelOccurenceBased extends WindowsAction {
    ...
    protected Result execute() {
        ...
        try {
            ...
            if (textPoint == null) {
                ...
                setErrorMessage("Given text is not found at the specified occurence.");
                ...
                Point elementLocation = calculateElementLocation(textPoint, position.getValue().toString());
    ...
    int x, y;
    private Point calculateElementLocation(OCRTextPoint textPoint, String position) {
