...
>>>>>>> Stashed changes
    ...
    public com.testsigma.sdk.Result execute() throws NoSuchElementException {
        ...
        try {
            ...
            actions.moveByOffset(xCoordinate, yCoordinate).contextClick().perform();

            setSuccessMessage("Successfully right clicked at coordinates X: " + xCoordinate + ", Y: " + yCoordinate);
            ...
            result = com.testsigma.sdk.Result.FAILED;
            logger.warn("Error occurred while right clicking at coordinates: " + e.getMessage());
            setErrorMessage("Error occurred while right clicking at coordinates: " + coordinates + ". Error: " + e.getMessage());
        }
