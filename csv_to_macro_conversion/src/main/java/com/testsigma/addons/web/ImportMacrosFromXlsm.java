...
public class ImportMacrosFromXlsm extends WebAction {
    ...
    public Result execute() {
        ...
        // Validate both files are readable XLSM workbooks via Apache POI
        ...
        try {
            ...
            // Parse the count of imported modules from the SUCCESS line
