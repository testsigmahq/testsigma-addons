...
@Data
@Action(actionText = "Enter test-data in the text area with preceding label text value",
        description = "Enters data into the text area for given preceding label",
        applicationType = ApplicationType.WEB)
public class EnterInTextAreaBoxWithPrecedingLabelText extends EnterInTextAreaBasedOnAttributeValues {
