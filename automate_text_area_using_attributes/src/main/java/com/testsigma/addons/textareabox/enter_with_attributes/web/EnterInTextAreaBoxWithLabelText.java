...
@Data
@Action(actionText = "Enter test-data in the text area with label text value",
        description = "Enters data into the text area for given label",
        applicationType = ApplicationType.WEB)
public class EnterInTextAreaBoxWithLabelText extends EnterInTextAreaBasedOnAttributeValues {
