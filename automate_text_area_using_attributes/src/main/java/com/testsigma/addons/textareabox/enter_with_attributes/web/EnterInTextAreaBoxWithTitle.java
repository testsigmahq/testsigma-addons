...
@Data
@Action(actionText = "Enter test-data in the text area with title value",
        description = "Enters data into the text area for given title",
        applicationType = ApplicationType.WEB)
public class EnterInTextAreaBoxWithTitle extends EnterInTextAreaBasedOnAttributeValues {
