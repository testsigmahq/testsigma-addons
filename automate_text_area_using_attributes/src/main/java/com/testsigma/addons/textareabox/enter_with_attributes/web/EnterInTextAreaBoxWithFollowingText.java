...
@Data
@Action(actionText = "Enter test-data in the text area with following text value",
        description = "Enters data into the text area for given following text",
        applicationType = ApplicationType.WEB)
public class EnterInTextAreaBoxWithFollowingText extends EnterInTextAreaBasedOnAttributeValues {
