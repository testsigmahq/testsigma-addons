...
@Data
@Action(actionText = "Enter test-data in the text area with placeholder value",
        description = "Enters data into the text area for given placeholder",
        applicationType = ApplicationType.WEB)
public class EnterInTextAreaBoxWithPlaceholderText extends EnterInTextAreaBasedOnAttributeValues {
