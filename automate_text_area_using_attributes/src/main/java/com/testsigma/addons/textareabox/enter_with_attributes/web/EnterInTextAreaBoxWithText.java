...
@Data
@Action(actionText = "Enter test-data in the text area with text value",
        description = "Enters data into the text area for given text",
        applicationType = ApplicationType.WEB)
public class EnterInTextAreaBoxWithText extends EnterInTextAreaBasedOnAttributeValues {
