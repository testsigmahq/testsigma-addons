...
@Data
@Action(actionText = "Enter test-data in the text area with following label text value",
        description = "Enters data into the text area for given following label",
        applicationType = ApplicationType.WEB)
public class EnterInTextAreaBoxWithFollowingLabelText extends EnterInTextAreaBasedOnAttributeValues {
