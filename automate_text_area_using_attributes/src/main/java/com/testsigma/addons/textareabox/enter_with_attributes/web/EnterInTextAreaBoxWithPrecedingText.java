...
@Data
@Action(actionText = "Enter test-data in the text area with preceding text value",
        description = "Enters data into the text area for given preceding text",
        applicationType = ApplicationType.WEB)
public class EnterInTextAreaBoxWithPrecedingText extends EnterInTextAreaBasedOnAttributeValues {
