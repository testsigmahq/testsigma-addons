...
@Data
@Action(actionText = "Click on text testdata, occurrence position found-at-position on system/desktop window",
        description = "Click on the text using the text coordinates in system/desktop window based on the occurrence",
        applicationType = ApplicationType.WEB,
        useCustomScreenshot = true)

public class ClickOnTextSystemOrDesktopOccurrenceBased extends WebAction {
    @OCR
    ...
    protected Result execute() {
        ...
        try{
            ...
            if(textPoint == null) {
                ...
                setErrorMessage("Given text with specified occurrence is not found");
                ...
                setSuccessMessage("Click operation performed on the text " + text.getValue() + " at occurrence " +  target_occurrence +
