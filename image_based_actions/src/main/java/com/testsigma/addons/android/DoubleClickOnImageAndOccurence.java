...
@Data
@Action(actionText = "Double click on the image image-url with threshold threshold-value  (Ex: 0.9 , means 90% match)" +
        "and occurrence occurrence-position",
        description = "Tap on give image (if there are multiple images, tap on the image based on occurrence position)",
        applicationType = ApplicationType.ANDROID)
public class DoubleClickOnImageAndOccurence extends AndroidAction {
        ...
        private com.testsigma.sdk.TestData occurrence_position_;
        ...
        public Result execute() throws NoSuchElementException {
            ...
            try {
                ...
                String occurrencePosition = occurrence_position_.getValue().toString();
                int[] start_points_1 = getImageXYCoOrdinates(imageURL.getValue().toString(), threshold, occurrencePosition);
        ...
        private int[] getImageXYCoOrdinates(String imageTestData, String threshold, String occurrencePosition) {
            try {
                ...
                // FindImageResponse findImage(String var1, Integer var2, Float var3);
                FindImageResponse response = ocr.findImage(imageTestData, Integer.parseInt(occurrencePosition),
