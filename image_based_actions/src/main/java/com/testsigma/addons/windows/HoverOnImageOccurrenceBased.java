...
@Data
@Action(
        actionText = "Mouse hover on image image-url, occurrence based found-at-position",
        description = "Mouse hover on given image, at given position",
        applicationType = ApplicationType.WINDOWS
)
public class HoverOnImageOccurrenceBased extends WindowsAction {
