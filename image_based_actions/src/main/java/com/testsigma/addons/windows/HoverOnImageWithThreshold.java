...
@Data
@Action(
        actionText = "Mouse hover on image image-url with applied search threshold threshold-value (Ex: 0.9 , means 90% match)",
        description = "Mouse hover on given image with threshold",
        applicationType = ApplicationType.WINDOWS
)
public class HoverOnImageWithThreshold extends WindowsAction {
