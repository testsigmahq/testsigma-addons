...
@Data
@Action(
        actionText = "Right-Click on image image-url with applied search threshold threshold-value (Ex: 0.9 , means 90% match), occurrence position found-at-position",
        description = "Right Click on given image with threshold at the given position",
        applicationType = ApplicationType.WINDOWS
)
public class RightClickOnImageWithThresholdOccurrenceBased extends WindowsAction {
