...
public class VerifyTextNotPresent extends WebAction {
    ...
    protected Result execute() {
        ...
        try {
            ...
            if (matchedTextPoint.isPresent()==false) {
                ...
                setSuccessMessage("Text \"" + textToVerify + "\" NOT found in the current screen.");
            } else {
                // Text was not found in the image
                result = Result.FAILED;
                setErrorMessage("Text \"" + textToVerify + "\" found in the current screen.");
            }
        } catch (Exception e) {
