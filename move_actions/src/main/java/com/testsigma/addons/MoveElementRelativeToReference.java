...
public class MoveElementRelativeToReference extends WebAction {
    ...
    @TestData(reference = "relativePosition", allowedValues = {"right", "left", "top", "bottom"})
    ...
    public com.testsigma.sdk.Result execute() {
        ...
        try {
            ...
            int targetXOffset = calculateXOffset(referenceWebElement, relativePosition, xOffset);
            int targetYOffset = calculateYOffset(referenceWebElement, relativePosition, yOffset);
            ...
            setErrorMessage("Target location is out of bounds: " + e.getMessage());
            logger.info(ExceptionUtils.getStackTrace(e));
            result = com.testsigma.sdk.Result.FAILED;
        }catch (Exception e) {
