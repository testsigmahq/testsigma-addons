...
@Action(actionText = "Tap and Hold(Long press) on the screen at the given position. Hold duration in seconds: Hold-Duration Tap Point: Tap-Point .Tap point is in x,y format where x is the Percentage of width and y is the percentage of height. Ex. Point: 50,50 (center of the screen)",
        applicationType = ApplicationType.ANDROID,
        useCustomScreenshot = false)
public class TapAndHoldOnPosition extends AndroidAction {

/*  @TestData(reference = "Zoom-Action",allowedValues = {"Pinch","Zoom"})
  private com.testsigma.sdk.TestData zoomAction;*/

    @TestData(reference = "Tap-Point")
    private com.testsigma.sdk.TestData tapPoint;
    ...
    protected com.testsigma.sdk.Result execute() throws NoSuchElementException {
        ...
        try {
            int[] tap_points_1 = computePoints(tapPoint.getValue().toString(), screenSize);
            ...
            Sequence swipe_1 = new Sequence(pointer_1, 1)
                    ...
                    .addAction(new Pause(pointer_1, Duration.ofSeconds(hold_duration)))
            ...
            androidDriver.perform(Arrays.asList(swipe_1));
