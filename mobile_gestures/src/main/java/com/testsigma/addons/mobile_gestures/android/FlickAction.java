...
@Data
@Action(actionText = "Flick Mobile screen to direction UP/DOWN/RIGHT/LEFT", applicationType = ApplicationType.ANDROID)
public class FlickAction extends AndroidAction {
