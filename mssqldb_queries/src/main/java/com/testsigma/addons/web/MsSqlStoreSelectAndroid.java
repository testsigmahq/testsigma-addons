...
@Data
@Action(actionText = "Execute MSSqlDB Select-Query on the connection DB_Connection_URL and store output into a variable-name",
...
public class MsSqlStoreSelectAndroid extends WebAction {
