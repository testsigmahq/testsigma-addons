...
import com.testsigma.addons.chrome_extension_actions.web.EnableChromeExtension;
...
public class TestEnableChromeExtension {
    ...
    public void validateEnable() throws Exception {
        EnableChromeExtension nlp = new EnableChromeExtension();
    ...
    public void validateDisable() throws Exception {
        EnableChromeExtension nlp = new EnableChromeExtension();
        nlp.setName(new TestData("Disable"));
