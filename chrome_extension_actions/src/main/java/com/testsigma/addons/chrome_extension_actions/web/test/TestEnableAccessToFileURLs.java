...
import com.testsigma.addons.chrome_extension_actions.web.EnableAccessToFileURLs;
...
public class TestEnableAccessToFileURLs {
    ...
    public void validateEnable() throws Exception {
        EnableAccessToFileURLs nlp = new EnableAccessToFileURLs();
        nlp.setName(new TestData("Testsigma"));
        nlp.setEnable(new TestData("Enable"));
    ...
    public void validateDisable() throws Exception {
        EnableAccessToFileURLs nlp = new EnableAccessToFileURLs();
        nlp.setName(new TestData("Testsigma"));
        nlp.setEnable(new TestData("Disable"));
        //place a debugger here, pause and manually click add extension button
        runner.run(nlp);
    }
