...
import com.testsigma.addons.chrome_extension_actions.web.ClickOnDetailsButton;
...
public class TestClickOnDetailsButton {
    ...
    public void validate() throws Exception {
        ClickOnDetailsButton nlp = new ClickOnDetailsButton();
