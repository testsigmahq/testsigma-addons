...
import com.testsigma.addons.chrome_extension_actions.web.EnableCollectErrors;
...
public class TestEnableCollectErrors {
    ...
    public void validate() throws Exception {
        EnableCollectErrors nlp = new EnableCollectErrors();
