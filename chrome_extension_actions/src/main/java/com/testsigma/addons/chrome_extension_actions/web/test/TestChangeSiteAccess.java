...
import com.testsigma.addons.chrome_extension_actions.web.ChangeSiteAccess;
...
public class TestChangeSiteAccess {
    ...
    public void validate() throws Exception {
        ChangeSiteAccess nlp = new ChangeSiteAccess();
        nlp.setName(new TestData("Testsigma"));
        nlp.setAccessLevel(new TestData("ON_SPECIFIC_SITES"));
