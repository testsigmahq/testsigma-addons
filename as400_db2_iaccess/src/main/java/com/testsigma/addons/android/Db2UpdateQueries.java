...
@Data
@Action(actionText = "Execute DB2 Update Query on the connection with host host, port port, database dbname, username username, password password",
description = "This action executes given DB2 update/insert/delete query against the connection provided and prints the no. of affected rows.",
applicationType = ApplicationType.ANDROID)
public class Db2UpdateQueries extends AndroidAction {
