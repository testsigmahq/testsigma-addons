...
@Data
@Action(actionText = "Enter test-data in the password text box with label text value",
        description = "Enters data into the password field for given label",
        applicationType = ApplicationType.WEB)
public class EnterInPasswordBoxWithLabelText extends EnterInPasswordBoxBasedOnAttribute {
