...
@Data
@Action(actionText = "Enter test-data in the password text box with following text value",
        description = "Enters data into the password field for given following text",
        applicationType = ApplicationType.WEB)
public class EnterInPasswordBoxWithFollowingText extends EnterInPasswordBoxBasedOnAttribute {
