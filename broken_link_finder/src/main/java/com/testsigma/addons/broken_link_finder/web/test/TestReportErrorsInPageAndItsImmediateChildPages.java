...
public class TestReportErrorsInPageAndItsImmediateChildPages {
    ...
    public void validate() throws Exception {
        ReportErrorsInPageAndItsImmediateChildPages nlp = new ReportErrorsInPageAndItsImmediateChildPages();
