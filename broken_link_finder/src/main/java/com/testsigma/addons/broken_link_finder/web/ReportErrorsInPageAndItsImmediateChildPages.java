...
@Action(actionText = "Check & report all console errors in url and immediate child pages",
        description = "Collects any possible error message given by the browser for a given URL and its immediate child pages",
        applicationType = ApplicationType.WEB)
public class ReportErrorsInPageAndItsImmediateChildPages extends WebAction {
