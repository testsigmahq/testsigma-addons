...
@Data
@Action(actionText = "Verify if image image-url not present on current-page",
        description = "verifies if image is not present on current-page",
        applicationType = ApplicationType.ANDROID,
        useCustomScreenshot = true)
public class VerifyImageNotPresentOnScreen extends AndroidAction {
  ...
  protected Result execute() throws NoSuchElementException {
    ...
    try {
      ...
      FindImageResponse response = ocr.findImage(imageURL_);
