...
@Data
@Action(actionText = "Replace character testdata1 in String testdata2 between positions ( start , end ) and store into testdata3", description = "Replaces the specified character to the string between the given start and end positions and stores it in runtime data", applicationType = ApplicationType.REST_API, useCustomScreenshot = false)
public class ReplaceCharacterInStringBetweenPositions extends RestApiAction {
