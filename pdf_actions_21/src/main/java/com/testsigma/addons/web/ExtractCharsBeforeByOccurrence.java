...
@Data
@Action(actionText = "Extract No_Of_Character characters before occurrence Occurrence of search_pattern from PDF using match type Match_Type and store in a runtime variable Variable_Name",
...
public class ExtractCharsBeforeByOccurrence extends WebAction {
