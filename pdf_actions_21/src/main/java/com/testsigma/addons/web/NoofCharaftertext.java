...
@Data
@Action(actionText = "Extract No_Of_Character characters after occurrence Occurrence of text test_data from PDF and store in a runtime variable Variable_Name",
        description = "Extracts the characters from the PDF after the specified occurrence of test_data (supports literal or regex match). Use Occurrence 1 for first, 2 for second, etc. Use_Regex true for regex pattern.",
