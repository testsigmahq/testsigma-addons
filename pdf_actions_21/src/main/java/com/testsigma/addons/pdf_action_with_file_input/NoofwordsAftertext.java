...
@Data
@Action(actionText = "Extract No_Of_Words words after occurrence Occurrence of text test_data from PDF at file path pdf_file_path and store in a runtime variable Variable_Name",
        description = "Extracts the words from the PDF (file path or URL) after the specified occurrence of test_data (supports literal or regex). Use Occurrence 1 for first, 2 for second, etc. Use_Regex true for regex pattern.",
        applicationType = ApplicationType.WEB)
public class NoofwordsAftertext extends PdfFileInputBase {
