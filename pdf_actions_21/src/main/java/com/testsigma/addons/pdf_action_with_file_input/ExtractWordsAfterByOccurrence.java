...
@Data
@Action(actionText = "Extract No_Of_Words words after occurrence Occurrence of search_pattern from PDF at file path pdf_file_path using match type Match_Type and store in a runtime variable Variable_Name",
...
public class ExtractWordsAfterByOccurrence extends PdfFileInputBase {
