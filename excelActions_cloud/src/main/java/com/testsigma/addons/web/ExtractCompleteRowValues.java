...
@Data
@Action(actionText = "Excel: Read the entire Row of the latest Excel file (.xlsx) using the Row Index and store it in a " + "variable named testdata", description = "Reads the entire Row" +
        " of the latest Excel file using the Row index and store it in a " + "variable named testdata", applicationType = ApplicationType.WEB, useCustomScreenshot = false)
public class ExtractCompleteRowValues extends WebAction {
    ...
    public com.testsigma.sdk.Result execute() throws NoSuchElementException {
        ...
        try {
            ...
            setSuccessMessage("Extracted the Complete Row Values and Stored it in variable " + testData2.getValue().toString() + " = " + runTimeData.getValue());
