...
@Data
@Action(actionText = "Excel: Read the entire Column of the Excel fileName using the Column Index and store it in a " +
        "variable named testdata",
        description = "Read the entire column of the latest Excel file using the column number and store it in a " +
                "variable named testdata",
        applicationType = ApplicationType.WEB,
        useCustomScreenshot = false)
public class ExtractCompleteColumnValueForGivenFile extends WebAction {
    ...
    public com.testsigma.sdk.Result execute() throws NoSuchElementException {
        ...
        try {
            ...
            setSuccessMessage("Extracted the Complete column Values and Stored it in variable "
                    + testData2.getValue().toString() + " and store it in " + runTimeData.getValue());
