...
public class EdgeExcelUtilities implements ExcelUtilities {

    private WebDriver driver;
    private Logger logger;

    public EdgeExcelUtilities(WebDriver driver, Logger logger) {
        this.driver = driver;
        this.logger = logger;
    }
    ...
    public String getDownloadedFileLocalPath() {
        ...
        try {
            ...
            String script = "return (function() {" +
                    ...
                    "            if (fileNameElement && fileNameElement.textContent.trim().toLowerCase().endsWith('.xlsx')) {" +
            ...
            if (result != null) {
                ...
                logger.info("Found excel file path: " + resultString);
                System.out.println("Found excel file path: " + resultString);
                return resultString;
            } else {
                System.out.println("Could not find excel file path.");
                logger.warn("No excel file found in downloads or an error occurred.");
                return null;
            }
        } catch (Exception e) {
