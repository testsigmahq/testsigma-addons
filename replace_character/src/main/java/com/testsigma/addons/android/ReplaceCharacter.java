...
@Data
@Action(actionText = "Replace an existing-character with new-character in testdata and store in latestword",
        description = "It replaces an existing character with new character in provided testdata",
        applicationType = ApplicationType.ANDROID,
        useCustomScreenshot = false)
public class ReplaceCharacter extends AndroidAction {

    @TestData(reference = "existing-character")
    private com.testsigma.sdk.TestData character1;
    @TestData(reference = "new-character")
