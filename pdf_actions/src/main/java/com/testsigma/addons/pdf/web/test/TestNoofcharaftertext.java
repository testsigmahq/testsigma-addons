...
import com.testsigma.addons.pdf.web.NoofCharaftertext;
...
public class TestNoofcharaftertext {
    ...
    @Test
    public void noofcharaftertextpdf() throws Exception {
        NoofCharaftertext nlp = new NoofCharaftertext();
