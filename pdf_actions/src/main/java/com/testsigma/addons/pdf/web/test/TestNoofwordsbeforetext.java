...
import com.testsigma.addons.pdf.web.NoofwordsBeforetext;
...
public class TestNoofwordsbeforetext {
    ...
    @Test
    public void NoofwordsBeforetextpdf() throws Exception {
        NoofwordsBeforetext nlp = new NoofwordsBeforetext();
        nlp.setTestData1(new TestData("2"));
        nlp.setTestData2(new TestData("PDF"));
