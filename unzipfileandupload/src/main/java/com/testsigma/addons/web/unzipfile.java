...
@Data
@Action(actionText = "Unzip the zipfile absolutefilepath to destination destfilepath and store the filepath into a variable testdata",
description = "Unzip the file and upload into a element",
applicationType = ApplicationType.WEB,
useCustomScreenshot = false)
public class unzipfile extends WebAction {
