...
@Data
@Action(actionText = "SnowflakeDB: Execute Query query-value on the Connection DB_Connection_URL and store the result into a runtime variable variable-name",
